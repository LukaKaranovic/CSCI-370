...
INSERT INTO MemberAccounts (accnum, contactName, email, deliveryAddress, signUpDate, activationDate, status) VALUES
('000003', 'Luka Karanovic', 'luka.karanovic@viu.ca', '678 Red Ave, Nanaimo', TO_DATE('05-Mar-20', 'DD-Mon-YY'), TO_DATE('05-Mar-20', 'DD-Mon-YY'), 'Active');
...
INSERT INTO SupplyRecords (accnum, productCode, supplyDate, quantity) VALUES
('000001', '1001', TO_DATE('21-Jan-24', 'DD-Mon-YY'), 1000);
...
('10001', '000001', TO_DATE('05-Feb-23', 'DD-Mon-YY'), 'S', TO_DATE('10-Feb-24', 'DD-Mon-YY'), TO_DATE('14-Feb-24', 'DD-Mon-YY'), 'B0000001', 3);
INSERT INTO Orders (orderNum, placedBy, placeTime, packageType, expectDate, deliverTime, receivedBarcode, receivedPNum) VALUES
('10002', '000002', TO_DATE('05-Feb-22', 'DD-Mon-YY'), 'L', TO_DATE('10-Nov-24', 'DD-Mon-YY'), TO_DATE('11-Nov-24', 'DD-Mon-YY'), 'B0000001', 2);
INSERT INTO Orders (orderNum, placedBy, placeTime, packageType, expectDate, deliverTime, receivedBarcode, receivedPNum) VALUES
('10003', '000003', TO_DATE('06-Feb-23', 'DD-Mon-YY'), 'M', TO_DATE('12-Nov-24', 'DD-Mon-YY'), NULL, 'B0000002', 1);
INSERT INTO Orders (orderNum, placedBy, placeTime, packageType, expectDate, deliverTime, receivedBarcode, receivedPNum) VALUES
('10004', '000003', TO_DATE('06-Feb-23', 'DD-Mon-YY'), 'L', TO_DATE('15-Nov-24', 'DD-Mon-YY'), NULL, 'B0000002', 2);
